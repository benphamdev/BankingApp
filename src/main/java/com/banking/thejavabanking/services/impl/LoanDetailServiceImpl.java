...
import static com.banking.thejavabanking.utils.InterestUtils.calculateMonthlyInterestPayment;
import static com.banking.thejavabanking.utils.InterestUtils.calculateMonthlyPrincipalPayment;
...
//            throw new AppException(LOAN_DETAIL_EXISTS);
    ...
    public double calculateInterest(Integer id, Enums.InterestType type) {
        ...
        return InterestUtils.calculateInterest(
                ...
                (type == Enums.InterestType.SIMPLE) ? false : true
        );
    }
