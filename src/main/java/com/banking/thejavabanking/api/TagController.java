...
import com.banking.thejavabanking.domain.notifications.services.impl.TagServiceImpl;
...
public class TagController {
    ...
    @PutMapping("/{id}")
    public BaseResponse<Tag> updateTag(
            @PathVariable @Min(1) Integer id, @RequestBody TagRequest tag
    ) {
