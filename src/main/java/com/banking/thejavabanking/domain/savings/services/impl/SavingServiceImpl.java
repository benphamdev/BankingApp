package com.banking.thejavabanking.domain.savings.services.impl;
...
import com.banking.thejavabanking.domain.savings.repositories.SavingRepository;
import com.banking.thejavabanking.domain.savings.services.ISavingService;
...
public class SavingServiceImpl implements ISavingService {
    ...
    public Saving createSavingAccount(SavingRequest savingRequest) {
        ...
        Saving saving = Saving.builder()
                              ...
                              .maturationDate(
                                      LocalDateTime.now().plusMinutes(savingRequest.getDuration()))
